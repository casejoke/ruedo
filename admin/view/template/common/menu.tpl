<ul class="main-menu">
  ...
  <li><a href="<?php echo $occasion_record; ?>"><i class="md md-receipt"></i> <?php echo $text_occasion_record; ?></a></li>
  ...
  <li class="sub-menu">
    ...
    <ul>
      ...
      <li><a href="<?php echo $season; ?>"><?php echo $text_season; ?></a></li>
      <li><a href="<?php echo $occasion_group; ?>"><?php echo $text_occasion_group; ?> </a></li>
    </ul>
  </li>
  <li class="sub-menu">
