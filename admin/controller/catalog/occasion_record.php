...
class ControllerCatalogOccasionRecord extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$occasion_info  = array();
			//подтянем  инфу о событии
			$occasion_info = $this->model_catalog_occasion->getOccasion($result['occasion_id']);

			//подтянем инфо о месте $occasion_info['occasion_place_id']
			$place_info = $this->model_catalog_place->getPlace($occasion_info['occasion_place_id']);
			...
			$data['occasion_records'][] = array(
				...
				'occasion_date'			=> rus_date($this->language->get('occasion_date_day_date_format'), strtotime($occasion_info['occasion_date'])),
				'occasion_time'			=> $occasion_info['occasion_time'],
				'place_name'			=> $place_info['title'],
				'metro_name'			=> $data['metro_results'][$place_info['metro_id']]['metro_title'],
