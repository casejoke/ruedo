      ...
      <div class="card-body card-padding table-responsive">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
          <table class="table">
              <thead>
                  <tr>
                    <th style="width: 1px;" class="text-center hidden"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></th>
                    ...
                    <th class="text-left"><?php echo $column_phone; ?></th>
                     <th class="text-left">Дата события</th>
                     <th class="text-left">Место</th>
                     <th class="text-left">Метро</th>
                     <th class="text-left hidden"><?php echo $column_status; ?></th>
                    <th class="text-right hidden"><?php echo $column_action; ?></th>
                  </tr>
              </thead>
              <tbody>
                  ...
                  <tr>
                    <td class="text-center hidden"><?php if (in_array($occasion_record['occasion_record_id'], $selected)) { ?>
                    ...
                    <td class="text-left"><?php echo $occasion_record['telephone']; ?></td>
                    <td class="text-left"><?php echo $occasion_record['occasion_date'].' '.$occasion_record['occasion_time']; ?></td>
                    <td class="text-left"><?php echo $occasion_record['place_name']; ?></td>
                    <td class="text-left"><?php echo $occasion_record['metro_name']; ?></td>
                    <td class="text-left hidden"><?php echo $occasion_record['status']; ?></td>
